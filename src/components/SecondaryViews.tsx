      ...
      <div className="space-y-4">
        ...
        <div className="bg-[#09090b] border border-amber-500/10 p-3.5 rounded">
          ...
          <p className="text-[11px] text-neutral-400 leading-normal font-sans">
            Wiroxa Studio secures all secret API values server-side. Do NOT enter direct API secret coordinates inside client web templates. Integrate actual keys via the <strong className="text-amber-400">Secrets configurations panel</strong> in the AI Studio platform settings interface.
          </p>
        </div>
      </div>
    </div>
