# Contributing to NMLL Studio Web 🚀
...
2. **Clone your Fork**
   ```bash
   git clone https://github.com/YOUR-USERNAME/nmll-studio.git
   cd nmll-studio
   ```
...
- Write clean, type-safe **TypeScript** and modular **React 19** components.
- Use **TailwindCSS** for styling, adhering to dark-mode cybernetic studio aesthetics.
...
- Provide step-by-step reproduction steps, environment info, and browser/Node versions.
